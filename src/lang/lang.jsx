export const lang = {
	...
	uk: {
		...
		forgotPAssword: {
			...
			ConfirmpasswordReq: "Потрібно підтвердження пароля",
	...
	uz: {
		...
		forgotPAssword: {
			...
			ConfirmpasswordReq: "Parolni tasdiqlash majburiy",
			...
			haveAccount: "Sizda allaqachon hisobingiz bormi?",
		...
		validateRegistration: {
			...
			registerAccount: "Hisobingizni ro'yxatdan o'tkazing",
		...
		login: {
			loginAccount: "Hisobingizga kiring",
		...
		footer: {
			...
			buy: "Xaridorlar",
			pickup: "Etkazib berish",
			contact: "Kontaktlar",
			serviceCenter: "Xizmat ko'rsatish markazi",
			feedback: "sharh qoldiring",
			vacancy: "Ishlar",
