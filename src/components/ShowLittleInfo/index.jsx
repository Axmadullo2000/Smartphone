					...
					<ul>
						...
						<li
							...
							{!!extraProductDetail.airpod &&
								extraProductDetail.airpod.types == "extra" && (
									<>
										{" "}
										<span className="character_item">{t("searchResult.type")} </span>
										<span className="character_value">
						...
						<li
							...
							{!!extraProductDetail.airpod &&
								extraProductDetail.airpod.types == "extra" && (
									<>
										<span className="character_item">								{t("showLittleinfo.corpus")}</span>
										<span className="character_value">
											{!!extraProductDetail.airpod &&
						...
						<li
							...
							{!!detailData.phone && detailData.phone.types == "smartphone" && (
								<>
									<span className="character_item">{t("searchResult.typeSimCard")}</span>
									<span className="character_value">
										{!!detailData.phone &&
							...
							{!!extraProductDetail.airpod &&
								extraProductDetail.airpod.types == "extra" && (
									<>
										<span className="character_item">{t("extraInfoAbout.workTime")}</span>
										<span className="character_value">
						...
						<li
							...
							{!!detailData.phone && detailData.phone.types == "smartphone" && (
								<>
									<span className="character_item">{t("searchResult.size")} (ШxВxТ) </span>
									<span className="character_value">
							...
							{!!extraProductDetail.airpod &&
								extraProductDetail.airpod.types == "extra" && (
									<>
										<span className="character_item">{t("extraInfoAbout.weight")} </span>
										<span className="character_value">
